//this is the schema file MenExpense.js

const mongoose = require("mongoose");

const MenFellowExpenseSchema = new mongoose.Schema(
  {
    name: {
      type: String,
      required: true,
    ...
    addedBy: {
      type: String, // member code like "MBR000027"
      required: true,
    },
    addedByRole: {
      type: String,
...
module.exports = mongoose.model("MenFellowExpense", MenFellowExpenseSchema);
