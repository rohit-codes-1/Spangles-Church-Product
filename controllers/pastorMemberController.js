  ...
  try {
    ...
    if (!req.body.familyId) {
      ...
      const newMember = new PastorFamilyMember({
        ...
        permanent_address: req.body.permanent_address
          ? JSON.parse(req.body.permanent_address)
          : { address: "", city: "", district: "", state: "", zip_code: "", country: "" },
        present_address: req.body.present_address
          ? JSON.parse(req.body.present_address)
          : { address: "", city: "", district: "", state: "", zip_code: "", country: "" },

        baptized_date: req.body.baptized_date ? new Date(req.body.baptized_date) : null,
        communion_date: req.body.communion_date ? new Date(req.body.communion_date) : null,
