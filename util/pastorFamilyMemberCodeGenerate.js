const Member = require("../Schema/pastorFamilyMemberSchema");

async function generatePastorFamilyMemberCode() {
  // Define the static part of the member code
  const patternPart = "PTFM";
...
module.exports = generatePastorFamilyMemberCode;
